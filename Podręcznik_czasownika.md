...
### 1.5. Kim jesteś w tym świecie? Rola postaci graczy
...
MG decyduje, kiedy potrzebny jest Test – zazwyczaj gdy wynik działania jest niepewny i może mieć ciekawe (lub katastrofalne) konsekwencje.
...
Gra w TEOHIPHIP RPG toczy się jako dialog. MG opisuje sytuację: epokę, miejsce, napotkanych ludzi (lub dinozaury), stan sprzętu i absurdalne polecenia z centrali. Gracze deklarują, co ich postacie robią. MG ocenia:
...
*Tu znajdzie się wypełniona przykładowa karta postaci jako wzór.*  

## Dodatek C: Słowniczek Terminów Temporalnych

* **TEOHIPHIP:** Telechroniczna Optymalizacja Historii Powszechnej Hyperputerem. Ambitny i katastrofalny projekt "naprawy" historii.  
* **Instytut Temporystyki (INT):** Organizacja zarządzająca podróżami w czasie i TEOHIPHIP.  
* **Chronocykl:** Podstawowy, jednoosobowy wehikuł czasu, przypominający rower/miotłę.  
* **Chronotrak, Czasowiec, Tempobil:** Większe wehikuły czasu.  
* **Czasownik:** Ogólne określenie pracownika INT zajmującego się podróżami w czasie, często technika lub pilota.  
* **Dziejoczyniec:** Agent lub naukowiec zajmujący się bezpośrednim "naprawianiem" historii.  
* **Ankieter Historyczny:** Agent wysyłany do badania opinii publicznej w przeszłości.  
* **MOIRA (Mobilna Inspekcja Ratunkowa):** Jednostka specjalna INT do radzenia sobie z temporalnymi problemami.  
* **Chronoklazm:** Gwałtowna anomalia lub katastrofa czasowa, często wynikająca z awarii sprzętu lub paradoksu.  
* **Pętla Czasowa:** Sytuacja, w której fragment czasu powtarza się w kółko, niekoniecznie identycznie.  
* **Zesłaniec:** Osoba (zazwyczaj pracownik INT) karnie wysłana i porzucona w przeszłości.  
* **GENEZIS, BREKEKEK, KOAKS, KWAK, HAMUŁA, DUPKI, AMOREK, TUMAN, ZADEK:** Kryptonimy potężnych (i zazwyczaj awaryjnych) urządzeń do manipulacji czasem i przestrzenią na dużą skalę.
